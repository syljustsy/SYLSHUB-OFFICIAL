...
local Window = Library.CreateLib("SYLSHUB MALL TYCOON", colors)
...
local Miscsect = Misc:NewSection("miscellaneous")
...
--AUTOFARM
AutoFarmSect:NewToggle("AutoCollectButtons", "Tp all the buttons to you and cash", function(bool)
    if state then
        shared.toggle = bool
        AutoBuy = bool
    else
...
AutoFarmSect:NewToggle("AutoSelectStore", "Auto Selects store", function(bool)
    if state then
        shared.toggle = bool
...
AutoFarmSect:NewToggle("AutoRebirth", "AutoRebirth", function(bool)
    if state then
        shared.toggle = bool
        AutoRebirth = bool
    else
...
--ANTI AFK
Miscsect:NewToggle("AntiAfk", "AntiAfk", function(bool)
    if state then
        shared.toggle = bool
        AntiAfk = bool
    else
...
--CREDITS
Creditssec:NewButton("SYL#0011", "ClickToCopy", function()
    setclipboard("SYL#0011")
end)
 
Creditssec:NewButton("Discrod Server", "ClickToCopy", function()
