...
local Window = Library.CreateLib("SYLSHUB BROKEN BONES", colors)
...
local AutoFarmSection = Autofarm:NewSection("first go to Mount Zaquillia level 1 before clicking start")
AutoFarmSection:NewToggle("Bone breaker ", "Breaks Bones for you", function(state)
    if state then
...
local Warning = Autofarm:NewSection("Little epileptic warning Though!")
