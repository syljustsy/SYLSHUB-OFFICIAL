...
local Window = Library.CreateLib("SYLSHUB ZOMBIE LAZARUS", colors)
...
LPsection:NewButton("Inf Ammo", "Gives you Infinite Ammo", function()
        loadstring(game:HttpGet(('https://pastebin.com/raw/cxLnnseA'), true))()
    end)   
end)
...
local ESPTAB = Window:NewTab("Player ESP")
