...
local Window = Library.CreateLib("SYLSHUB TIMBER", "Sentinel")

local Main = Window:NewTab("Configs")
local ConfigsSection = Main:NewSection("UI Toggle")
ConfigsSection:NewKeybind("Toggle UI", "KeybindInfo", Enum.KeyCode.RightShift, function()
	Library:ToggleUI()
end)
ConfigsSection:NewButton("Anti Afk", "Make you UNKICKABLE!", function()
...
local SectionAutoFarm = Autofarm:NewSection("AutoFarm")
SectionAutoFarm:NewButton("AutoFarm", "AutoFarm by drakker33", function()
    loadstring(game:HttpGet(("https://raw.githubusercontent.com/drakker33/rblx-timber/main/Timber.lua"), true))()
end)

local AutoClicker = Window:NewTab("Handi Stuff")
local SectionAutoClicker = AutoClicker:NewSection("Stuff")
SectionAutoClicker:NewButton("AutoClicker, F5 to start,F6 to stop!", "Lets you click auto", function(state)
    loadstring(game:HttpGet("https://pastebin.com/raw/jMcVd5cv", true))()
end)
SectionAutoClicker:NewButton("Fly E to toggle", "LETS YOU FLYY HIGH", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/7rXZ9VNc", true))()
end)
SectionAutoClicker:NewToggle("Noclip", "Makes you go through walls", function(state)
    if state then
        noclip = true
    else
        noclip = false
...
SectionAutoClicker:NewSlider("WalkSpeed", "Makes you walk faster", 250, 16, function(s) -- 500 (MaxValue) | 0 (MinValue)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
end)
SectionAutoClicker:NewSlider("JumpHeight", "Makes you Jump heigher", 250, 50, function(s) -- 500 (MaxValue) | 0 (MinValue)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = s
end)

local TelePort = Window:NewTab("TelePorts")
local TelePortsection = TelePort:NewSection("WayPoints")
TelePortsection:NewDropdown("Teleports", "DropdownInf", {"Main Tree", "Lava Tree", "Ice Tree", "Pirate Tree"}, function(currentOption)
    if currentOption == "Main Tree" then
        local player = game.Players.LocalPlayer
	    player.Character.HumanoidRootPart.CFrame = CFrame.new(-50.762, 13.25, 135.477)        
    elseif currentOption == "Lava Tree" then
        local player = game.Players.LocalPlayer
	    player.Character.HumanoidRootPart.CFrame = CFrame.new(-572.233, 62.847, 1960.681)
    elseif currentOption == "Ice Tree" then
        local player = game.Players.LocalPlayer
	    player.Character.HumanoidRootPart.CFrame = CFrame.new(2225.104, 92.93, 127.309)
    elseif currentOption == "Pirate Tree" then
        local player = game.Players.LocalPlayer
	    player.Character.HumanoidRootPart.CFrame = CFrame.new(-173.073, 28.961, -1147.579)
    end       
end)
